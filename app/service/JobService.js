...
RESP_URL = "/api/job-responsibility/";
DELETE_URL = "/api/job-roles/";
...
module.exports.getJobResponsibilityByID = async function (id) {
  if (isNaN(id)) {
    throw new Error("Invalid ID");
  }
  try {
...
module.exports.deleteJob = async function (id) {
  if (isNaN(id)) {
    throw new Error("Invalid ID");
  }
  try {
